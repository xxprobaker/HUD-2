local function Base()
	...
	draw.RoundedBox(0, ScrW() - 1250 - 10, ScrH () - 130 - 10, 350, 125, Color(255, 255, 255, 150))

--------------------------------------------------------------------
-- Health
--------------------------------------------------------------------

	draw.RoundedBox(0, ScrW() - 1190, ScrH () - 75, 350-80, 20, Color(0, 0, 0, 150))
	...
	draw.RoundedBox(0, ScrW() - 1190, ScrH () - 75, (350-80) * DrawHealth / 100, 20, Color(255, 0, 0, 150))

    draw.DrawText( "Health:                    "..EchoHealth.."%", "Trebuchet24", ScrW() - 1260 + 4, ScrH () - 75 - 2, Color(70, 70, 70,255))

--------------------------------------------------------------------
-- Armor
--------------------------------------------------------------------

	draw.RoundedBox(0, ScrW() - 1190, ScrH () - 50, 350-80, 20, Color(0, 0, 0, 150))
	...
	draw.RoundedBox(0, ScrW() - 1190, ScrH () - 50, (350-80) * DrawHealth / 100, 20, Color(0,255,0,150))

    draw.DrawText( "Armor:                    "..EchoHealth.."%", "Trebuchet24", ScrW() - 1260 + 4, ScrH () - 50 - 2, Color(70, 70, 70,255))

--------------------------------------------------------------------
-- The Line
--------------------------------------------------------------------

	draw.RoundedBox(0, ScrW() - 1250, ScrH () - 105, 130 + 30, 2, Color(0, 100, 100, 255))

	draw.RoundedBox(0, ScrW() - 1080, ScrH () - 105, 130 + 30, 2, Color(0, 100, 100, 255))

--------------------------------------------------------------------
-- Job
--------------------------------------------------------------------

	draw.DrawText( "Job: "..LocalPlayer():getDarkRPVar( "job" ), "ChatFont", ScrW() - 1225 + 160, ScrH () - 105 + 3, Color(100, 0, 100, 255))

--------------------------------------------------------------------
-- Player Name
--------------------------------------------------------------------

	draw.DrawText( LocalPlayer():Nick(), "ChatFont", ScrW() - 1250 + 3, ScrH () - 105 + 3, Color(100, 0, 100, 255))

--------------------------------------------------------------------
-- Salary
--------------------------------------------------------------------

	draw.DrawText( "Sallary: $"..LocalPlayer():getDarkRPVar( "salary" ), "ChatFont", ScrW() - 1250 + 3, ScrH () - 115 - 7, Color(100, 0, 100, 255))

--------------------------------------------------------------------
-- Money
--------------------------------------------------------------------

	draw.DrawText( "Wallet: $"..LocalPlayer():getDarkRPVar( "money" ), "ChatFont", ScrW() - 1225 + 160, ScrH () - 115 - 7, Color(100, 0, 100, 255))
